...
__lib__ = (f'https://raw.githubusercontent.com/PauloCesar-dev404/{__repo_name__}/main/{__lib_name__}-{__version__}-py3'
           f'-none-any.whl')
__source__ = (f'https://raw.githubusercontent.com/PauloCesar-dev404/{__repo_name__}/main/{__lib_name__}-{__version__}'
              f'.tar.gz')
